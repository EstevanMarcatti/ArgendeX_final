...
def criar_tarefa(data):
    ...
    sql = "INSERT INTO tarefa (title, description, date, time, user_id) VALUES (%s, %s, %s, %s, %s)"
...
def atualizar_tarefa(data):
    ...
    cursor = connection.cursor()
    sql = "UPDATE tarefa SET title=%s, description=%s, date=%s, time=%s WHERE id=%s"
...
def criar_tarefa(data):
    ...
    cursor = connection.cursor()
    sql = "INSERT INTO tasks (title, description, date, time) VALUES (%s, %s, %s, %s)"
    valores = (data['title'], data['description'], data['date'], data['time'])
    cursor.execute(sql, valores)
    connection.commit()
    cursor.close()
    connection.close()
